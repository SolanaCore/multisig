...
impl RevokeApproval {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&RevokeApprovalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RevokeApprovalInstructionData {
            discriminator: [u8; 8],
      }

impl RevokeApprovalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [44, 51, 184, 108, 182, 202, 20, 53],
                  }
  }
}

impl Default for RevokeApprovalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `RevokeApproval`.
///
/// ### Accounts:
///
                ///   0. `[writable]` multisig
...
pub struct RevokeApprovalBuilder {
...
impl RevokeApprovalBuilder {
  ...
  /// `revoke_approval` CPI accounts.
  pub struct RevokeApprovalCpiAccounts<'a, 'b> {
...
/// `revoke_approval` CPI instruction.
pub struct RevokeApprovalCpi<'a, 'b> {
...
impl<'a, 'b> RevokeApprovalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: RevokeApprovalCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `RevokeApproval` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` multisig
                ...
                ///   2. `[signer]` proposer
#[derive(Clone, Debug)]
pub struct RevokeApprovalCpiBuilder<'a, 'b> {
  instruction: Box<RevokeApprovalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RevokeApprovalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RevokeApprovalCpiBuilderInstruction {
      __program: program,
              multisig: None,
              transaction: None,
              proposer: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        let instruction = RevokeApprovalCpi {
...
#[derive(Clone, Debug)]
struct RevokeApprovalCpiBuilderInstruction<'a, 'b> {
