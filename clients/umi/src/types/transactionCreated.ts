...
export function getTransactionCreatedSerializer(): Serializer<
  TransactionCreatedArgs,
  TransactionCreated
> {
  return struct<TransactionCreated>(
    [
    ...
    { description: 'TransactionCreated' }
  ) as Serializer<TransactionCreatedArgs, TransactionCreated>;
}
