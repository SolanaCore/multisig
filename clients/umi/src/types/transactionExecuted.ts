...
export function getTransactionExecutedSerializer(): Serializer<
  TransactionExecutedArgs,
  TransactionExecuted
> {
  return struct<TransactionExecuted>(
    [
    ...
    { description: 'TransactionExecuted' }
  ) as Serializer<TransactionExecutedArgs, TransactionExecuted>;
}
