...
exports.getTransactionCreatedEncoder = getTransactionCreatedEncoder;
exports.getTransactionCreatedDecoder = getTransactionCreatedDecoder;
exports.getTransactionCreatedCodec = getTransactionCreatedCodec;
const kit_1 = require("@solana/kit");
const _1 = require(".");
function getTransactionCreatedEncoder() {
...
function getTransactionCreatedDecoder() {
...
function getTransactionCreatedCodec() {
    return (0, kit_1.combineCodec)(getTransactionCreatedEncoder(), getTransactionCreatedDecoder());
}
